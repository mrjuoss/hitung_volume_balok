package com.mrjuoss.dicoding.volume.balok;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_calculate) {
            ...
            if (width == null) {
                isInvalidDouble = true;
                edt_width.setError("Field ini harus berupa nomer yang valid");
            }

            if (height == null) {
                isInvalidDouble = true;
                edt_height.setError("Field ini harus berupa nomer yang valid");
            }
